...
func (x *LoginResponse) GetRecode() int32 {
	if x != nil {
		return x.Recode
	}
	return 0
...
var file_Login_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x22, 0x3e, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	...
	0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x72, 0x65, 0x63, 0x6f, 0x64, 0x65,
	0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x4a, 0x0a, 0x0c, 0x4c, 0x6f,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0a, 0x5a, 0x08, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
...
var file_Login_proto_depIdxs = []int32{
	0, // 0: protobuf.LoginService.Login:input_type -> protobuf.LoginRequest
	1, // 1: protobuf.LoginService.Login:output_type -> protobuf.LoginResponse
...
// LoginServiceRPCClient is the client API for LoginService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type LoginServiceRPCClient interface {
	// Register 测试方法
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error)
}

type loginServiceRPCClient struct {
	cc grpc.ClientConnInterface
}

func NewLoginServiceRPCClient(cc grpc.ClientConnInterface) LoginServiceRPCClient {
	return &loginServiceRPCClient{cc}
}

func (c *loginServiceRPCClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
